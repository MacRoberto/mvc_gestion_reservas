...
class HabitacionController
{
    ...
    {
        $tipo_habitacion = new Habitacion();
        ...
        if ($accion == 'nuevo') {
            ...
            $habitaciones->guardar($tipo_habitacion, $descripcion, $capacidad_adultos, $capacidad_ninos, $capacidad_camas, $precio_noche, $moneda,$disponible_general);
            ...
            $habitaciones = $habitaciones->obtenerTodos();//>Consultas
